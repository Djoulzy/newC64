...
func (C *CPU) initLanguage() {
	mnemonic = map[byte]instruction{
		...
		0x02: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0x12: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0x22: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0x32: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0x42: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0x52: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0x62: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0x72: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0x92: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0xB2: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0xD2: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		0xF2: {name: "KIL", bytes: 1, cycles: 1, action: func() { C.state = idle; fmt.Printf("\n") }, addr: implied},
		...
		0xEA: {name: "NOP", bytes: 1, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: implied},
		0x1A: {name: "NOP", bytes: 1, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: implied},
		0x3A: {name: "NOP", bytes: 1, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: implied},
		0x5A: {name: "NOP", bytes: 1, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: implied},
		0x7A: {name: "NOP", bytes: 1, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: implied},
		0xDA: {name: "NOP", bytes: 1, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: implied},
		0xFA: {name: "NOP", bytes: 1, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: implied},
		0x80: {name: "NOP", bytes: 2, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: immediate},
		0x82: {name: "NOP", bytes: 2, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: immediate},
		0xC2: {name: "NOP", bytes: 2, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: immediate},
		0xE2: {name: "NOP", bytes: 2, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: immediate},
		0x89: {name: "NOP", bytes: 2, cycles: 2, action: func() { fmt.Printf("\n"); return }, addr: immediate},
		0x04: {name: "NOP", bytes: 2, cycles: 3, action: func() { fmt.Printf("\n"); return }, addr: zeropage},
		0x44: {name: "NOP", bytes: 2, cycles: 3, action: func() { fmt.Printf("\n"); return }, addr: zeropage},
		0x64: {name: "NOP", bytes: 2, cycles: 3, action: func() { fmt.Printf("\n"); return }, addr: zeropage},
		0x14: {name: "NOP", bytes: 2, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: zeropageX},
		0x34: {name: "NOP", bytes: 2, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: zeropageX},
		0x54: {name: "NOP", bytes: 2, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: zeropageX},
		0x74: {name: "NOP", bytes: 2, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: zeropageX},
		0xD4: {name: "NOP", bytes: 2, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: zeropageX},
		0xF4: {name: "NOP", bytes: 2, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: zeropageX},
		0x0C: {name: "NOP", bytes: 3, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: absolute},
		0x1C: {name: "NOP", bytes: 3, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: absoluteX},
		0x3C: {name: "NOP", bytes: 3, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: absoluteX},
		0x5C: {name: "NOP", bytes: 3, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: absoluteX},
		0x7C: {name: "NOP", bytes: 3, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: absoluteX},
		0xDC: {name: "NOP", bytes: 3, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: absoluteX},
		0xFC: {name: "NOP", bytes: 3, cycles: 4, action: func() { fmt.Printf("\n"); return }, addr: absoluteX},
